...
\begin{table}[!h]
    ...
    \begin{tabular}{cllll}
        ...
        \bottomrule[1.5pt]
    \end{tabular}
    \caption{PC-104 connector pinout. \textcolor{red}{Add additional interfaces and synchronize nomenclature}}
...
\begin{figure}[!htb]
    \begin{center}
        \subfigure[Debug interface of the antenna module.\label{fig:ant-debug-connector}]{\includegraphics[width=0.115\textwidth]{figures/p5-connector.png}}
        \qquad
        \subfigure[Main interface of the antenna module.\label{fig:ant-main-connector}]{\includegraphics[width=0.15\textwidth]{figures/p4-connector.png}}
