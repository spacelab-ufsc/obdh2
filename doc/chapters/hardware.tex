...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.45\textwidth]{figures/daughterboard-size.png}
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.65\textwidth]{figures/daughterboard-integration.png}
...
\subsubsection{USCI\_A0: SPI}
 Config: Chip Selects - 5, Length - 8bits, Phase - High, Polarity - Low, Endianness - MSB, Data Rate - 400kbps

\subsubsection{USCI\_A1: UART1}
Config: Baundrate - 115200, Data Bits - 8 bits, Parity - None, Stop Bits - 1

\subsubsection{USCI\_A2: UART0}
Config: Baundrate - 115200, Data Bits - 8 bits, Parity - None, Stop Bits - 1

\subsubsection{USCI\_B0: I2C0}
Config: Master, Slave Address Length - 7 bits, Data Rate - 100kbps

\subsubsection{USCI\_B0: I2C0}
Config: Master, Slave Address Length - 7 bits, Data Rate - 100kbps

\subsubsection{USCI\_B0: I2C1}
Config: Master, Slave Address Length - 7 bits, Data Rate - 100kbps

\subsubsection{USCI\_B0: I2C2}
Config: Master, Slave Address Length - 7 bits, Data Rate - 100kbps
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.78\textwidth]{figures/msp430-pinout.png}
        \caption{Microcontroller pinout positions.}
        \label{fig:msp430-pinout}
    \end{center}
\end{figure}
