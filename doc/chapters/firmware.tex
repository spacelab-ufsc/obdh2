...
\begin{table}[!h]
    \centering
    \begin{tabular}{lllC{1cm}}
        \toprule[1.5pt]
        \textbf{ID} & \textbf{Name/Description} & \textbf{Type} & \textbf{Length [bytes]} \\
        \midrule
        0 & Time counter in milliseconds                            & uint32    & 4 \\
        1 & Temperature of the uC in Kelvin                         & uint16    & 2 \\
        2 & Input current in mA                                     & uint16    & 2 \\
        3 & Input voltage in mA                                     & uint16    & 2 \\
        \multirow{18}{*}{4} & Last reset cause: & \multirow{18}{*}{uint8} & \multirow{18}{*}{1} \\
        ...
        5 & Reset counter                                           & uint16    & 2 \\
        6 & Last valid telecommand (uplink packet ID)               & uint8     & 1 \\
        \bottomrule[1.5pt]
    \end{tabular}
