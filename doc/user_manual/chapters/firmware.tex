...
\begin{table}[!ht]
	...
	\begin{tabular}{clcc}
		...
		25                  & RSSI of the last valid telecommand.       & uint16             & 2                     \\
        27                  & Temperature of the antenna module in K    & uint16             & 2                     \\
        29                  & Antenna status                            & uint16             & 2                     \\
		31                  & Antenna deployment status                 & uint8              & 1                     \\
		32                  & Antenna deploymaent hibernation status    & uint8              & 1                     \\
		33                  & TX packet counter                         & uint32             & 4                     \\
		37                  & RX packet counter                         & uint32             & 4                     \\
		\midrule                                                                                                    
        Total               & -                                         & -                  & 41                    \\
		\bottomrule[1.5pt]
	\end{tabular}
...
\begin{landscape}
	\begin{table}[ht]
		...
		\begin{tabular}{llccccc}
			...
			\midrule
			\multirow{1}{*}{Beacon}        & EPS data                              & 00h                                  & \multirow{1}{*}{`` '' + ``PY0EFS''} & EPS data                                          & 46                    & Public  \\
			\midrule
			...
			\multirow{14}{*}{Uplink}       & Ping request                          & 40h                                  & \multirow{14}{*}{Any Callsign}      & None                                              & 8                     & Public  \\
			                               ...
			                               & Update TLE                            & 4Dh                                  &                                     & TLE line 1 + TLE line 2 + Hash                    & 166                   & Private \\
			\bottomrule[1.5pt]
		\end{tabular}
