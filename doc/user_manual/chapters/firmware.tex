...
\begin{longtable}[c]{cL{0.82\textwidth}l}
	...
	\midrule
    0                    & System time in seconds (Unix epoch)                                     & uint32                   \\
	...
	13                   & Mode (``Normal'' = 0, ``Hibernation'' = 1, ``Stand-by'' = 2)            & uint8                    \\
	14                   & Timestamp of the last mode change                                       & uint32                   \\
	15                   & Mode duration in sec.                                                   & uint32                   \\
...
\begin{table}[!ht]
	...
	\begin{tabular}{clcc}
		...
		18                & EDC board temperature + $40$ in Celsius               & uint8             & 1                      \\
...
\begin{table}[!ht]
	...
	\begin{tabular}{clcc}
		...
		77                  & Last TLE update timestamp                & uint32             & 4                     \\   
		81                  & Last sensor readings timestamp           & uint32             & 4                     \\   
		\midrule                                                                                                    
        Total               & -                                        & -                  & 93                    \\
		\bottomrule[1.5pt]
	\end{tabular}
