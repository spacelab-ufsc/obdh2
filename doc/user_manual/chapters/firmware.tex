...
\begin{longtable}[c]{cL{0.70\textwidth}lc}
    ...
    16                   & First TLE line                                                                   & string                   & W                   \\
    17                   & Second TLE line                                                                  & string                   & W                   \\
    18                   & Satellite's latitude in degress                                                  & int16                    & R                   \\
    19                   & Satellite's longitude in degress                                                 & int16                    & R                   \\
    20                   & Satellite's altitude in kilometers                                               & int16                    & R                   \\
    21                   & Last written flash page in OBDH sector                                           & uint32                   & R                   \\
    22                   & Last written flash page in EPS sector                                            & uint32                   & R                   \\
    23                   & Last written flash page in TTC 0 sector                                          & uint32                   & R                   \\
    24                   & Last written flash page in TTC 1 sector                                          & uint32                   & R                   \\
    25                   & Last written flash page in Antenna sector                                        & uint32                   & R                   \\
    26                   & Last written flash page in EDC sector                                            & uint32                   & R                   \\
    27                   & Last written flash page in Payload X sector                                      & uint32                   & R                   \\
    28                   & Last written flash page in SBCD packets sector                                   & uint32                   & R                   \\
    29                   & Manual mode enabled                                                              & boolean                  & R/W                 \\
    30                   & Main EDC ID (See \autoref{tab:system-ids} for ID values)                         & uint8                    & R/W                 \\
    31                   & General telemetry enabled                                                        & boolean                  & R/W                 \\
    32                   & Reset device (Resets OBDH when ``01h'' is written into it)                       & boolean                  & W                   \\
    33                   & Timestamp of the last TLE line set update in sec.                                & uint32                   & R                   \\
    34                   & Timestamp of the last OBDH sensor's reading in sec.                              & uint32                   & R                   \\
    35                   & Main payload state (Active payload ID or 0 if disabled)                          & uint32                   & R/W                 \\
    36                   & Secondary payload state (Active payload ID or 0 if disabled)                     & uint32                   & R/W                 \\
    37                   & Remaining hibernation time in sec.                                               & uint32                   & R/W                 \\
	\bottomrule[1.5pt]
