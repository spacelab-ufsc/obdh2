...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.6\textwidth]{figures/flowchart_OBDH.drawio.pdf}
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.2\textwidth]{figures/flowchart_obdh_boot_sequence.drawio.pdf}
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.45\textwidth]{figures/flowchart_antenna_deploy_routine.drawio.pdf}
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.75\textwidth]{figures/tc_processing_flow.drawio.pdf}
